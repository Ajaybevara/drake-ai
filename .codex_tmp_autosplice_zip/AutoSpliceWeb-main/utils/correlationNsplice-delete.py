...
def las_export(xys, uniqueLogs, filname):
    ...
    las.insert_curve(0, 'DEPT', xys[:, 0], unit='m', descr='Depth')

    # Loop through the rest of the lognames and insert curves
    for i, lkey in enumerate(uniqueLogs, start=1):  # start=1 to skip the depth curve
        ...
        las.insert_curve(i, lkey, xys[:, i], unit=unit, descr=descr)
...
# if (__name__=='__main__'):
    ...
    # las_file_path='auto-select-btnData\loggy_out_res.las'
